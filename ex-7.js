...
console.log("creditCardTypeOfBlindermann:", creditCardTypeOfBlindermann);
console.log("productQuantityOfJoannet:", productQuantityOfJoannet);
console.log("totalPurchaseOfDary:", totalPurchaseOfDary);
